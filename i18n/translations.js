    ...
    "index": {
      "pt-BR": {
        ...
        "entries": [
          ...
          { "selector": ".site-nav a:nth-child(2)", "text": "Precos" },
          { "selector": ".site-nav a:nth-child(3)", "text": "Historia" },
          { "selector": ".site-nav a:nth-child(4)", "text": "Entrar" },
          ...
          { "selector": ".hero-actions a:nth-child(2)", "text": "Ver precos" },
      ...
      "en-US": {
        ...
        "entries": [
          ...
          { "selector": ".site-nav a:nth-child(1)", "text": "Home" },
          { "selector": ".site-nav a:nth-child(2)", "text": "Pricing" },
          { "selector": ".site-nav a:nth-child(3)", "text": "Story" },
          { "selector": ".site-nav a:nth-child(4)", "text": "Join" },
          ...
          { "selector": ".hero-actions a:nth-child(2)", "text": "See pricing" },
    ...
    "why": {
      "pt-BR": {
        ...
        "entries": [
          ...
          { "selector": ".why-content p:nth-child(1)", "html": "Maria Jeane Pereira (<time datetime=\"1956\">&ast; 1956</time> – <time datetime=\"2020\">&#10013; 2020</time>), dedicou a vida a cuidar de pessoas, especialmente dos mais necessitados. Esse exemplo me inspira como filho e me inspirou a criar esta plataforma." },
          { "selector": ".why-content p:nth-child(2)", "text": "No mundo de AppSec, existe muito barulho e pouca direção. Eu não quis criar mais uma vitrine de recursos e features. Eu quis criar utilidade real para problema real." },
          { "selector": ".why-content p:nth-child(3)", "html": "Por isso M.A.R.I.A. significa <strong>Management Application Risk Integrated Analysis</strong>. Não só uma sigla, mas algo que representa uma escolha: cuidar." },
      ...
      "en-US": {
        ...
        "entries": [
          ...
          { "selector": ".why-content p:nth-child(1)", "html": "Maria Jeane Pereira (<time datetime=\"1956\">&ast; 1956</time> - <time datetime=\"2020\">&#10013; 2020</time>) dedicated her life to caring for people, especially those in greatest need. Her example inspires me as a son, and it inspired me to build this platform." },
          { "selector": ".why-content p:nth-child(2)", "text": "In AppSec, there is too much noise and too little direction. I did not want to build another feature showcase. I wanted practical value for serious day-to-day problems." },
          { "selector": ".why-content p:nth-child(3)", "html": "That is why M.A.R.I.A. stands for <strong>Management Application Risk Integrated Analysis</strong>. Not just an acronym, but a choice: to care." },
